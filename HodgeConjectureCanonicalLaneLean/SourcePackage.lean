/-!
# Source package model for `hodge-conjecture-canonical-lane`
...
def sourceCheckoutHead : String := "1a5b0d6967a4f69d27db0dea49ee553933c56bbd"
...
def sourceFiles : List SourceFile := [
  ...
  { path := "scripts/hodge_closure_guard.py", sha256 := "3a891f77fc2b232cf170769770540833c7f3a9919f2a19ed45de75a7cf2b383b", functionCount := 9, classCount := 0, assignmentCount := 7, parseOk := true },
...
def sourceFunctions : List SourceFunctionDecl := [
  ...
  { file := "scripts/hodge_closure_guard.py", name := "_finite", args := ["v"], returns := "bool", doc := "", line := 32, isAsync := false },
  { file := "scripts/hodge_closure_guard.py", name := "_resolve", args := ["path_str"], returns := "Path", doc := "", line := 36, isAsync := false },
  { file := "scripts/hodge_closure_guard.py", name := "_bootstrap_registry", args := ["path"], returns := "None", doc := "", line := 43, isAsync := false },
  { file := "scripts/hodge_closure_guard.py", name := "_load_registry", args := ["path"], returns := "dict[str, Any]", doc := "", line := 59, isAsync := false },
  { file := "scripts/hodge_closure_guard.py", name := "_load_sigma_from_stitch", args := ["path"], returns := "float | None", doc := "", line := 71, isAsync := false },
  { file := "scripts/hodge_closure_guard.py", name := "_entry", args := ["constants", "key"], returns := "tuple[float | None, bool]", doc := "", line := 88, isAsync := false },
  { file := "scripts/hodge_closure_guard.py", name := "compute_report", args := ["data", "sigma_star", "strict_coh_zero"], returns := "dict[str, Any]", doc := "", line := 99, isAsync := false },
  { file := "scripts/hodge_closure_guard.py", name := "append_history", args := ["path", "report"], returns := "None", doc := "", line := 214, isAsync := false },
  { file := "scripts/hodge_closure_guard.py", name := "main", args := [], returns := "None", doc := "", line := 226, isAsync := false },
...
def sourceAssignments : List SourceAssignmentDecl := [
  ...
  { file := "scripts/hodge_closure_guard.py", name := "SCRIPT_DIR", value := "Path(__file__).resolve().parent", line := 13 },
  { file := "scripts/hodge_closure_guard.py", name := "PROJECT_ROOT", value := "SCRIPT_DIR.parent", line := 14 },
  { file := "scripts/hodge_closure_guard.py", name := "DEFAULT_REGISTRY", value := "\"artifacts/constants_registry.json\"", line := 16 },
  { file := "scripts/hodge_closure_guard.py", name := "DEFAULT_STITCH", value := "\"artifacts/stitch_constants.json\"", line := 17 },
  { file := "scripts/hodge_closure_guard.py", name := "DEFAULT_OUT", value := "\"repro/certificate_runtime.json\"", line := 18 },
  { file := "scripts/hodge_closure_guard.py", name := "DEFAULT_HISTORY", value := "\"repro/drift_guard_runs.jsonl\"", line := 19 },
  { file := "scripts/hodge_closure_guard.py", name := "REQUIRED_KEYS", value := "[\"kappa_hodge\", \"sigma_capture\", \"kappa_compact\", \"rho_rigidity\", \"alpha_alg\", \"a_floor\", \"eps_coh\"]", line := 21 },
...
def constantSpecs : List ConstantSpec := [
  { group := "constants", key := "kappa_hodge", status := "derived_numeric", formula := "c_star_raw * A_ker_raw - e_star_raw", sourceSection := "paper/HODGE_CONJECTURE_PREPRINT.md Appendix A", validation := "required_positive", componentKeys := ["A_ker_raw", "c_star_raw", "e_star_raw"] },
  { group := "constants", key := "sigma_capture", status := "derived_numeric", formula := "sigma_floor_raw - flow_loss_raw - jump_loss_raw", sourceSection := "paper/HODGE_CONJECTURE_PREPRINT.md Appendix B", validation := "required_positive", componentKeys := ["flow_loss_raw", "jump_loss_raw", "sigma_floor_raw"] },
  { group := "constants", key := "kappa_compact", status := "derived_numeric", formula := "1.0 / (1.0 + delta_comp_sup_raw)", sourceSection := "paper/HODGE_CONJECTURE_PREPRINT.md Appendix C", validation := "required_positive", componentKeys := ["delta_comp_sup_raw"] },
  { group := "constants", key := "rho_rigidity", status := "derived_numeric", formula := "rho_rigidity_raw", sourceSection := "paper/HODGE_CONJECTURE_PREPRINT.md Appendix D", validation := "required_positive", componentKeys := ["rho_rigidity_raw"] },
  { group := "constants", key := "alpha_alg", status := "derived_numeric", formula := "alpha_alg_raw", sourceSection := "paper/HODGE_CONJECTURE_PREPRINT.md Appendix E", validation := "required_positive", componentKeys := ["alpha_alg_raw"] },
  { group := "constants", key := "a_floor", status := "derived_numeric", formula := "a_floor_raw", sourceSection := "paper/HODGE_CONJECTURE_PREPRINT.md Appendix E", validation := "required_positive", componentKeys := ["a_floor_raw"] },
  { group := "constants", key := "eps_coh", status := "derived_numeric", formula := "eps_coh_raw", sourceSection := "paper/HODGE_CONJECTURE_PREPRINT.md Appendix E", validation := "required_nonnegative", componentKeys := ["eps_coh_raw"] },
  { group := "stitch", key := "sigma_star_can", status := "derived_numeric", formula := "sigma_star_can_raw", sourceSection := "paper/HODGE_CONJECTURE_PREPRINT.md Section 5 / stitch constants", validation := "required_positive", componentKeys := ["sigma_star_can_raw"] }
]

def registryConstants : List RegistryConstant := [
  { key := "a_floor", value := "1.019", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#a_floor", sourceSection := "paper/HODGE_CONJECTURE_PREPRINT.md Appendix E" },
  { key := "alpha_alg", value := "1.041", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#alpha_alg", sourceSection := "paper/HODGE_CONJECTURE_PREPRINT.md Appendix E" },
  { key := "eps_coh", value := "0.0", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#eps_coh", sourceSection := "paper/HODGE_CONJECTURE_PREPRINT.md Appendix E" },
  { key := "kappa_compact", value := "0.8090614886731392", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#kappa_compact", sourceSection := "paper/HODGE_CONJECTURE_PREPRINT.md Appendix C" },
  { key := "kappa_hodge", value := "1.10264", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#kappa_hodge", sourceSection := "paper/HODGE_CONJECTURE_PREPRINT.md Appendix A" },
  { key := "rho_rigidity", value := "1.088", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#rho_rigidity", sourceSection := "paper/HODGE_CONJECTURE_PREPRINT.md Appendix D" },
  { key := "sigma_capture", value := "1.0759999999999998", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#sigma_capture", sourceSection := "paper/HODGE_CONJECTURE_PREPRINT.md Appendix B" }
]
...
def registryConstantCount : Nat := 7
