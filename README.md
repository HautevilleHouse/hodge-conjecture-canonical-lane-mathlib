# Hodge Conjecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/hodge-conjecture-canonical-lane-mathlib.git
cd hodge-conjecture-canonical-lane-mathlib
lake exe
lake build
```
